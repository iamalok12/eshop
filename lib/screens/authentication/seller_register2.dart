            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  Text("Add details",style: TextStyle(fontFamily: "Orbitron",fontSize: 30.sp),),
                  ...
                  SizedBox(height: 25.h,),
                  PrimaryTextField(controller: locality, label: "Locality", keyboardType: TextInputType.name, textFieldOptions:PrimaryTextFieldOptions.name),
                  SizedBox(height: 25.h,),
                  PrimaryTextField(controller: area, label: "Area", keyboardType: TextInputType.streetAddress, textFieldOptions:PrimaryTextFieldOptions.name),
                  SizedBox(height: 25.h,),
                  PrimaryTextField(controller: pinCode, label: "Pin code", keyboardType: TextInputType.number, textFieldOptions:PrimaryTextFieldOptions.pinCode),
